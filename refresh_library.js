...
// لأعمال موجودة، ويحدّث تقييمها وكاستها. منفصل تماماً عن update_library.js لأن هذا
...
async function refreshLibrary() {
    ...
    // من update_library.js، فإعادة فحصها هنا تكرار غير مفيد. نستثني كذلك ملفات النظام.
